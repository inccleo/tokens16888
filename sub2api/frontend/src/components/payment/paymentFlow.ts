...
export function decidePaymentLaunch(
  ...
  const prefersQr = normalizedPaymentMode === 'qrcode'
    ...
    || (!prefersRedirect && (!!baseState.qrCode || !!baseState.qrCodeImg))
  ...
  if (prefersQr && (baseState.qrCode || baseState.qrCodeImg)) {
...
export function readPaymentRecoverySnapshot(
  ...
  try {
    ...
    if (
      ...
      || (parsed.qrCodeImg != null && typeof parsed.qrCodeImg !== 'string')

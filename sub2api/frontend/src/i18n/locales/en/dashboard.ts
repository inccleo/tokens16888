export default {
  dashboard: {
    ...
    createFirstKeyTitle: 'Create your first API key',
    createFirstKeyDesc: 'Generate a key to start calling models',
    firstCallTitle: 'Make your first call',
    firstCallDesc: 'Copy the example below, swap in your key, and run it',
    noBalanceTitle: 'No available balance',
    noBalanceDesc: 'Add funds to start using the API',
    lowBalanceWarning: 'Balance is low — consider adding funds',
    serviceStatus: 'Service status',
    serviceOperational: 'Platform API reachable',
    serviceChecking: 'Checking platform API',
    serviceUnavailable: 'Platform API is not reachable',
    serviceStatusHint: 'This check confirms API reachability only; upstream model availability may differ.',
    retryServiceCheck: 'Check again',
    viewServiceStatus: 'View channel status',
    announcementsTitle: 'Announcements',
    noAnnouncements: 'No announcements',
    viewAll: 'View all',
    detailedMetrics: 'More metrics',
    usageInsights: 'Usage insights',
    browseModels: 'Browse models',
    browseModelsDesc: 'See available models and pricing',
    quickStart: 'Quick start',
    quickStartDesc: 'Three steps to your first call',
    baseUrl: 'API base URL',
    copyExample: 'Copy example',
    stepCreateKey: 'Create and copy an API key',
    stepCopyExample: 'Copy the example below',
    stepSendRequest: 'Swap in your key and send the request',
  ...
  docsHub: {
    ...
    subtitle: 'Create an API key and send your first model request.',
    quickStart: 'Quick start',
    stepOneTitle: 'Create an API key',
    stepOneDescription: 'Create a dedicated key for your project, then choose a client configuration in the usage guide.',
    stepTwoTitle: 'Choose an available model',
    stepTwoDescription: 'Review available models, pricing, and the protocol supported by your group.',
    stepThreeTitle: 'Send an API request',
    stepThreeDescription: 'Replace the model and key values before running this example. Confirm the model supports this compatible endpoint.',
    endpoint: 'API base URL',
    openAIExample: 'OpenAI-compatible example',
    copyExample: 'Copy example',
    copied: 'Request example copied',
    apiKeyPlaceholder: 'YOUR_API_KEY',
    modelPlaceholder: 'MODEL_ID',
    relatedGuides: 'Related guides',
    batchImageGuide: 'Batch image guide',
    configuredDocs: 'Site documentation',
    docsNotConfigured: 'The administrator has not configured an external documentation link.',
  },
  ...
  modelPlaza: {
    ...
    noFavorites: 'No favorite models yet — tap the star next to a model to add it',

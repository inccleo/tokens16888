export default {
    settings: {
      ...
      payment: {
        ...
        field_paymentCurrencyHint: 'Default is CNY. Stripe and Airwallex can choose HKD, USD, or another listed currency supported by the account; WeChat Pay, Alipay, EasyPay, and XunHuPay remain CNY.',
        ...
        field_xunhupayApiBaseHint: 'Defaults to https://api.xunhupay.com. Use https://api.dpweixin.com as the backup host. Enter the gateway root, not /payment/do.html.',

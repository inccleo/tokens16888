export default {
    settings: {
      ...
      payment: {
        ...
        field_paymentCurrencyHint: '默认 CNY。Stripe 和 Airwallex 可按账户支持从下拉项选择 HKD、USD 等币种；微信、支付宝、易支付、虎皮椒仍按 CNY。',
        field_accountIdHint: '不涉及多账户、组织级密钥或连接账户收款时可以不填；单账户 Scoped API Key 会默认使用所选账户。',
        field_appSecret: 'App Secret',
        field_xunhupayApiBaseHint: '默认 https://api.xunhupay.com。备用平台可填 https://api.dpweixin.com。请填写网关根地址，不要带 /payment/do.html。',
        field_cid: '支付渠道 ID',
